import json
from python.flet_snippets_creator.flet_create_attributes_widgets import (
    attrs_all_placeholders_complete,
)
from python.flet_snippets_creator.flet_create_widgets import only_controls
from python.flet_snippets_creator.flet_create_modules_widgets import only_modules
...
class make_snippet:
    ...
    """
    instance = make_snippet(path='./python', file_name='python.json')
    ```
    ...
    def __init__(self, path: str = "./python", file_name: str = "python.json"):
        self.path = path
    ...
    def write_json(self, data_to_write: dict = {}, tag_name: str = "tag-name"):
        ...
        print(f"[*] - SNIPPET WAS CREATE {tag_name} python.json")
...
if __name__ == "__main__":
    ...
    # texto = """
    # """
    # instance = make_snippet(path="./python", file_name="flet_widgets_python.json")
    ...
    instance = make_snippet(path="./python/", file_name="flet_attribute_widgets.json")
    # print(attrs_all_placeholders_complete)
    # MAKE SNIPPETS FROM DICT
    # PYTHON.FLET_SNIPPETS_CREATOR.FLET_CREATE_ATTRIBUTES_WIDGETS IMPORT
    for index, value in attrs_all_placeholders_complete.items():
        name = f"flet widgets {index}"
        prefix = f"at.{index}"
    ...
    instance.write_json(data_to_write=old_data, tag_name="flet-attributes")

    # ==================== CREATE WIDGETS WIDGETS ======================

    instance = make_snippet(path="./python/", file_name="flet_widgets.json")
    # print(attrs_all_placeholders_complete)
    # MAKE SNIPPETS FROM DICT
    # PYTHON.FLET_SNIPPETS_CREATOR.FLET_CREATE_ATTRIBUTES_WIDGETS IMPORT
    ...
    del old_data[""]
    old_data.update(check_value)
    instance.write_json(data_to_write=old_data, tag_name="flet-widgets")
    # ==================== CREATE WIDGETS MODULES WIDGETS ======================

    instance = make_snippet(path="./python/", file_name="flet_modules_widgets.json")
    # print(attrs_all_placeholders_complete)
    # MAKE SNIPPETS FROM DICT
    # PYTHON.FLET_SNIPPETS_CREATOR.FLET_CREATE_ATTRIBUTES_WIDGETS IMPORT
    for index, value in only_modules.items():
        name = f"flet modules widgets {index}"
    ...
    del old_data[""]
    old_data.update(check_value)
    instance.write_json(data_to_write=old_data, tag_name="flet-modules-widgets")
    # # ==================== DUMP ALL IN python.json=====================

    # ATTRIBUTES
    instance_attributes = make_snippet(
        path="./python/",
        file_name="flet_attribute_widgets.json",
    )
    # WIDGETS
    instance_widgets = make_snippet(
        path="./python/",
        file_name="flet_widgets.json",
    )
    # MODULES
    instance_modules_widgets = make_snippet(
        path="./python/",
        file_name="flet_modules_widgets.json",
    )

    # WIDGETS in python.js FINAL
    ...
    instance_final_widgets.write_json(
        data_to_write=all_data, tag_name="flet-all-together"
    )
    # print(all_data)
